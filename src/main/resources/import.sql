...
insert into empleados(id,direccion,dni,estado_civil,fecha_nacimiento,nombre,telefono,grado_academico)values(2,'villa del mar',322,'soltero','2000-07-07','test',980989181,'Universitario');
...
insert into contratos(id, activo, asignacion_familiar, cargo, fecha_fin, fecha_inicio, horas_contratadas, valor_hora, afp_id, empleado_id)VALUES(1,1,1,'tester','2021-12-12','2021-01-01',320,20,2,1);
